...
const MmprpgAlldataShow = ({ MmprpgData, loddingM }) => {
  const navigate = useNavigate();
  return (
    <>
      <h1 className="m-t">TOP MMPRPG GAMES</h1>
      <div className="mmprpgdata">
        {loddingM ? (
          <>
            <Lodding />
          </>
        ) : (
          MmprpgData.map((res, index) => {
            return (
              <>
...
export default MmprpgAlldataShow;
