...
const SciFicAllData = ({ scificdeta, scilodding }) => {
  const navigate = useNavigate();
  return (
    <>
      <h1 className="m-t">TOP SCI_FI GAMES</h1>
      <div className="sci-ficdata">
        {scilodding ? (
          <Lodding />
        ) : (
          scificdeta.map((res, index) => {
            return (
              <>
