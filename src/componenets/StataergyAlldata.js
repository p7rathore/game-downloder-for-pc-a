...
const StataergyAlldata = ({ STRATEGYData, SloddingData }) => {
  const navigate = useNavigate();
  return (
    <>
      <h1 className="m-t">TOP STRATEGY GAMES</h1>
      <div className="STRATEGYDATA">
        {SloddingData ? (
          <Lodding />
        ) : (
          STRATEGYData.map((res, index) => {
            return (
              <>
...
export default StataergyAlldata;
